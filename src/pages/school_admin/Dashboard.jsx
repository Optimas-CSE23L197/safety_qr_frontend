 ...
 *
 * Modified:
 *  - Removed "Upgrade Plan" button from top bar
 *  - Removed "Upgrade to unlock" button from Token Status → replaced with lock icon only
 *  - Removed "Upgrade to Premium" button from PlanCard section → replaced with lock icon only
 */
    ...
    return (
        <div style={{ maxWidth: '1400px' }}>
            ...
            <div style={{
                ...
                {/* ✅ REMOVED: "Upgrade Plan" button — replaced with lock icon only */}
                {!isPremium && (
                    <div style={{
                        ...
                        <Lock size={15} color="var(--color-slate-400)" />
                        <span style={{
                            fontSize: '0.8125rem', fontWeight: 500,
            ...
            <div className="stagger-children" style={{
                ...
                {/* Premium-only stat cards — lock icon only, no button */}
                <StatCard
                    label="Avg Scan Time"
            ...
            <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            <div style={{
                                ...
                                {CHART_PERIODS.map(({ label, value, premiumOnly }) => {
                                    ...
                                    if (isLocked) {
                                        return (
                                            // ✅ MODIFIED: lock icon only, no navigate on click
                                            <button
                                                key={value}
                                                title="Premium only"
                                                style={{
                ...
                <div className="card" style={{ padding: '24px' }}>
                    ...
                    {!isPremium ? (
                        // ✅ MODIFIED: "Upgrade to unlock" button REMOVED — lock icon only
                        <div style={{
                            display: 'flex', flexDirection: 'column',
                            ...
                            {/* ❌ REMOVED: Upgrade to unlock button */}
                        </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 320px', gap: '16px' }}>
                ...
                {/* Plan card — ✅ "Upgrade to Premium" button is inside PlanCard.jsx */}
                {/* Pass a prop to PlanCard to hide the upgrade button */}
                <PlanCard
                    plan={plan}
                    isPremium={isPremium}
